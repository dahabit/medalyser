...
class Application_Form_RegisterDoctor extends Zend_Form {
	...
	public function __construct($options = null) {
		...
		$firstname->addErrorMessage ( 'Your firstname can consist solely of letters and should not be empty' );
		
		$middlename = new Zend_Form_Element_Text ( 'middlename' );
		$middlename->addValidator ( 'Alpha' );
		$middlename->addErrorMessage ( 'Middlename can consist solely of letters and numbers' );
		
		$lastname = new Zend_Form_Element_Text ( 'lastname' );
		$lastname->setRequired ( true );
		$lastname->addValidator ( 'Alpha' );
		$lastname->addErrorMessage ( 'Lastname can consist solely of letters and should not be empty' );
		...
		$this->addElements ( array ($primaryemail, $firstname, $middlename, $lastname, $password, $confirmPswd  ) );
	}
