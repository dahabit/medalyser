...
class Zend_Test_PHPUnit_Constraint_ResponseHeader extends PHPUnit_Framework_Constraint
{
     ...
     * @var array
     */
    protected $_assertTypes = array(self::ASSERT_RESPONSE_CODE, 
    self::ASSERT_HEADER, self::ASSERT_HEADER_CONTAINS, self::ASSERT_HEADER_REGEX);
    /**
    ...
    public function evaluate ($other, $assertType = null)
    {
        ...
        if (! in_array($assertType, $this->_assertTypes)) {
            require_once 'Zend/Test/PHPUnit/Constraint/Exception.php';
            throw new Zend_Test_PHPUnit_Constraint_Exception(
            sprintf('Invalid assertion type "%s" provided to %s constraint', 
        ...
        switch ($assertType) {
            ...
            case self::ASSERT_HEADER_CONTAINS:
                ...
                $header, $match) : $this->_headerContains($response, $header, 
                $match);
            case self::ASSERT_HEADER_REGEX:
                ...
                $header, $match) : $this->_headerRegex($response, $header, 
                $match);
            default:
                require_once 'Zend/Test/PHPUnit/Constraint/Exception.php';
                throw new Zend_Test_PHPUnit_Constraint_Exception(
