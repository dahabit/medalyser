...
class Zend_Log
{
    ...
    protected function _constructFormatterFromConfig ($config)
    {
        ...
        if (! $formatter instanceof Zend_Log_Formatter_Interface) {
            ...
            require_once 'Zend/Log/Exception.php';
            throw new Zend_Log_Exception(
            $formatterName . ' does not implement Zend_Log_Formatter_Interface');
        }
        return $formatter;
    }
    /**
    ...
    {
        return array_merge(
        array('timestamp' => date($this->_timestampFormat), 
    ...
    public function registerErrorHandler ()
    {
        ...
        E_NOTICE => Zend_Log::NOTICE, E_USER_NOTICE => Zend_Log::NOTICE, 
        E_WARNING => Zend_Log::WARN, E_CORE_WARNING => Zend_Log::WARN, 
        E_USER_WARNING => Zend_Log::WARN, E_ERROR => Zend_Log::ERR, 
        E_USER_ERROR => Zend_Log::ERR, E_CORE_ERROR => Zend_Log::ERR, 
    ...
    $errcontext)
    {
        ...
        if ($errorLevel && $errno) {
            ...
            array('errno' => $errno, 'file' => $errfile, 'line' => $errline, 
            'context' => $errcontext));
        }
