...
class Zend_Text_Figlet
{
        ...
        for ($row = 0; $row < $this->_charHeight; $row ++) {
            if ($this->_rightToLeft === 1) {
                ...
                for ($k = 0; $k < $smushAmount; $k ++) {
                    ...
                    $this->_outputLine[$row][$position] = $this->_smushem(
                    $leftChar, $this->_currentChar[$row][$k]);
                }
    ...
    protected function _loadFont ($fontFile)
    {
        ...
        '%*c%c %d %*d %d %d %d %d %d', $this->_hardBlank, $this->_charHeight, 
        $this->_maxLength, $smush, $cmtLines, $rightToLeft, $this->_fontSmush);
