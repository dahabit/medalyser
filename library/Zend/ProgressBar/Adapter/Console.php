...
class Zend_ProgressBar_Adapter_Console extends Zend_ProgressBar_Adapter
{
     ...
     * @var array
     */
    protected $_elements = array(self::ELEMENT_PERCENT, self::ELEMENT_BAR, 
    self::ELEMENT_ETA);
    /**
    ...
    {
        $allowedElements = array(self::ELEMENT_PERCENT, self::ELEMENT_BAR, 
        self::ELEMENT_ETA, self::ELEMENT_TEXT);
    ...
    public function setFinishAction ($action)
    {
        ...
        self::FINISH_ACTION_EOL, self::FINISH_ACTION_NONE);
            ...
            switch ($element) {
                case self::ELEMENT_BAR:
                    ...
                    if ($doneWidth > 0) {
                        ...
                        ceil($doneWidth / strlen($this->_barLeftChar))), 0, 
                        $doneWidth);
                    }
                    ...
                    if ($leftWidth > 0) {
                        ...
                        ceil($leftWidth / strlen($this->_barRightChar))), 0, 
                        $leftWidth);
                    }
                    $bar .= ']';
                ...
                case self::ELEMENT_TEXT:
                    ...
                    substr($text, 0, $this->_textWidth), $this->_textWidth, ' ', 
                    STR_PAD_RIGHT, $this->_charset);
                    break;
            }
        }
