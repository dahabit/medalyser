...
abstract class Zend_Server_Abstract implements Zend_Server_Interface
{
     ...
     */
    protected static $magic_methods = array('__call', '__clone', '__construct', 
    '__destruct', '__get', '__isset', '__set', '__set_state', '__sleep', 
    '__tostring', '__unset', '__wakeup');
    /**
    ...
    Zend_Server_Reflection_Function_Abstract $reflection, $class = null)
    {
        ...
        foreach ($reflection->getPrototypes() as $proto) {
            ...
            foreach ($proto->getParameters() as $parameter) {
                ...
                array('type' => $this->_fixType($parameter->getType()), 
