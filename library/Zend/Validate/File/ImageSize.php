...
class Zend_Validate_File_ImageSize extends Zend_Validate_Abstract
{
     ...
     */
    protected $_messageVariables = array('minwidth' => '_minwidth', 
    'maxwidth' => '_maxwidth', 'minheight' => '_minheight', 
    'maxheight' => '_maxheight', 'width' => '_width', 'height' => '_height');
    /**
     * Minimum image width
     *
     * @var integer
    ...
    {
        return array('minwidth' => $this->_minwidth, 
    ...
    {
        return array('maxwidth' => $this->_maxwidth, 
    ...
    {
        return array('minheight' => $this->_minheight, 
        'maxheight' => $this->_maxheight);
    }
    /**
