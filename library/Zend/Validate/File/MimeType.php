...
class Zend_Validate_File_MimeType extends Zend_Validate_Abstract
{
     ...
     * @var array
     */
    protected $_magicFiles = array('/usr/share/misc/magic', 
    '/usr/share/misc/magic.mime', '/usr/share/misc/magic.mgc', 
    '/usr/share/mime/magic', '/usr/share/mime/magic.mime', 
    '/usr/share/mime/magic.mgc', '/usr/share/file/magic', 
    '/usr/share/file/magic.mime', '/usr/share/file/magic.mgc');
    /**
    ...
    public function isValid ($value, $file = null)
    {
        ...
        if (empty($this->_type) &&
         (function_exists('mime_content_type') && ini_get(
