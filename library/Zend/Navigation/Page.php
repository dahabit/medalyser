...
abstract class Zend_Navigation_Page extends Zend_Navigation_Container
{
    ...
    public function setParent (Zend_Navigation_Container $parent = null)
    {
        ...
        if (null !== $this->_parent &&
         ! $this->_parent->hasPage($this, false)) {
    ...
    public function toArray ()
    {
        ...
        array('label' => $this->getlabel(), 'id' => $this->getId(), 
        'class' => $this->getClass(), 'title' => $this->getTitle(), 
        'target' => $this->getTarget(), 'rel' => $this->getRel(), 
        'rev' => $this->getRev(), 'order' => $this->getOrder(), 
        'resource' => $this->getResource(), 'privilege' => $this->getPrivilege(), 
        'active' => $this->isActive(), 'visible' => $this->isVisible(), 
