...
class Zend_Mail extends Zend_Mime_Message
{
    ...
    public function setType ($type)
    {
        ...
        Zend_Mime::MULTIPART_MIXED, Zend_Mime::MULTIPART_RELATED);
    ...
    {
        $allowed = array(Zend_Mime::ENCODING_BASE64, 
    ...
    $mimeType = Zend_Mime::TYPE_OCTETSTREAM, $disposition = Zend_Mime::DISPOSITION_ATTACHMENT, $encoding = Zend_Mime::ENCODING_BASE64, $filename = null)
    {
        ...
        if (Zend_Mime::isPrintable($value) === false) {
            if ($this->getHeaderEncoding() ===
             Zend_Mime::ENCODING_QUOTEDPRINTABLE) {
                ...
                $this->getCharset(), Zend_Mime::LINELENGTH, Zend_Mime::LINEEND);
            } else {
    ...
    {
        $prohibit = array('to', 'cc', 'bcc', 'from', 'subject', 'reply-to', 
