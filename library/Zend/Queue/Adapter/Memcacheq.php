...
class Zend_Queue_Adapter_Memcacheq extends Zend_Queue_Adapter_AdapterAbstract
{
    ...
    public function send ($message, Zend_Queue $queue = null)
    {
        ...
        $data = array('message_id' => md5(uniqid(rand(), true)), 
        'handle' => null, 'body' => $message, 'md5' => md5($message));
    ...
    Zend_Queue $queue = null)
    {
        ...
        if ($maxMessages > 0) {
            for ($i = 0; $i < $maxMessages; $i ++) {
                $data = array('handle' => md5(uniqid(rand(), true)), 
    ...
    public function getCapabilities ()
    {
        ...
        'send' => true, 'receive' => true, 'deleteMessage' => false, 
        'getQueues' => true, 'count' => false, 'isExists' => true);
    }
    /********************************************************************
