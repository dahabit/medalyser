...
class Zend_Queue_Adapter_PlatformJobQueue extends Zend_Queue_Adapter_AdapterAbstract
{
    ...
    public function send ($message, Zend_Queue $queue = null)
    {
        ...
        if (! $jobId) {
            require_once 'Zend/Queue/Exception.php';
            throw new Zend_Queue_Exception(
            'Failed to add a job to queue: ' . $this->_zendQueue->getLastError());
        }
    ...
    Zend_Queue $queue = null)
    {
        ...
        $options = array('queue' => $this->_queue, 'data' => $jobs, 
    ...
    {
        return array('create' => false, 'delete' => false, 
        'getQueues' => false, 'isExists' => false, 
        'count' => true, 'send' => true, 'receive' => true, 
        'deleteMessage' => true);
    }
    /********************************************************************
