...
class Zend_Http_Client
{
    ...
    'httpversion' => self::HTTP_1, 'keepalive' => false, 
    'storeresponse' => true, 'strict' => true, 'output_stream' => false, 
    'encodecookies' => true, 'rfc3986_strict' => false);
    /**
    ...
    public function setAuth ($user, $password = '', $type = self::AUTH_BASIC)
    {
        ...
        if ($user === false || $user === null) {
            ...
            $this->auth = array('user' => (string) $user, 
            'password' => (string) $password, 'type' => $type);
        }
        return $this;
    }
    /**
    ...
    public function setFileUpload ($filename, $formname, $data = null, $ctype = null)
    {
        ...
        $this->files[] = array('formname' => $formname, 
        'filename' => basename($filename), 'ctype' => $ctype, 
        'data' => $data);
    ...
    public function setAdapter ($adapter)
    {
        if (is_string($adapter)) {
            try {
                ...
                require_once 'Zend/Http/Client/Exception.php';
                throw new Zend_Http_Client_Exception(
                "Unable to load adapter '$adapter': {$e->getMessage()}", 0, $e);
            }
            $adapter = new $adapter();
        }
    ...
    public function request ($method = null)
    {
        ...
        do {
            ...
            $uri->getPort(), ($uri->getScheme() == 'https' ? true : false));
