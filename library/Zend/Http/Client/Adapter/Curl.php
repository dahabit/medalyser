...
Zend_Http_Client_Adapter_Interface, Zend_Http_Client_Adapter_Stream
{
    ...
    public function __construct ()
    {
        ...
        $this->_invalidOverwritableCurlOptions = array(CURLOPT_HTTPGET, 
        CURLOPT_POST, CURLOPT_PUT, CURLOPT_CUSTOMREQUEST, CURLOPT_HEADER, 
    ...
    $body = '')
    {
        ...
        if ($this->out_stream) {
            ...
            curl_setopt($this->_curl, CURLOPT_FILE, 
            $this->out_stream);
        } else {
        ...
        if ($method == Zend_Http_Client::POST) {
            ...
            curl_setopt($this->_curl, 
            CURLOPT_INFILE, $this->_config['curloptions'][CURLOPT_INFILE]);
