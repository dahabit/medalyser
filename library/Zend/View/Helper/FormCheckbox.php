...
class Zend_View_Helper_FormCheckbox extends Zend_View_Helper_FormElement
{
     ...
     * @var array
     */
    protected static $_defaultCheckedOptions = array('checkedValue' => '1', 
    'uncheckedValue' => '0');
    /**
    ...
    array $checkedOptions = null)
    {
        ...
        $xhtml .= '<input type="checkbox"' . ' name="' .
         $this->view->escape($name) . '"' . ' id="' . $this->view->escape($id) .
    ...
    array $checkedOptions = null)
    {
        ...
        return array('checked' => $checked, 'checkedString' => $checkedString, 
        'checkedValue' => $checkedValue, 'uncheckedValue' => $uncheckedValue);
    }
}
