...
abstract class Zend_View_Abstract implements Zend_View_Interface
{
    ...
    public function getPluginLoader ($type)
    {
        ...
        if (! in_array($type, $this->_loaderTypes)) {
            require_once 'Zend/View/Exception.php';
            $e = new Zend_View_Exception(
            sprintf('Invalid plugin loader type "%s"; cannot retrieve', $type));
            $e->setView($this);
            throw $e;
        }
    ...
    public function assign ($spec, $value = null)
    {
        ...
        if (is_string($spec)) {
            ...
            require_once 'Zend/View/Exception.php';
            $e = new Zend_View_Exception(
            'assign() expects a string or array, received ' . gettype($spec));
            $e->setView($this);
            throw $e;
        }
        return $this;
    ...
    private function _setPath ($type, $path, $classPrefix = null)
    {
        ...
        switch ($type) {
            ...
            default:
                ...
                array('prefix' => 'Zend_View_' . ucfirst($type) . '_', 
