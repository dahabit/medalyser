...
class Zend_Log_Writer_Mail extends Zend_Log_Writer_Abstract
{
     ...
     * @var array
     */
    protected static $_methodMapHeaders = array('from' => 'setFrom', 
    'to' => 'addTo', 'cc' => 'addCc', 'bcc' => 'addBcc');
    /**
     * Class constructor.
     *
    ...
    {
        $config = array_merge(
        array('layout' => 'Zend_Layout', 'layoutOptions' => null), $config);
