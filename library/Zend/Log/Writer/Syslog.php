...
class Zend_Log_Writer_Syslog extends Zend_Log_Writer_Abstract
{
    ...
    Zend_Log::ALERT => LOG_ALERT, Zend_Log::CRIT => LOG_CRIT, 
    Zend_Log::ERR => LOG_ERR, Zend_Log::WARN => LOG_WARNING, 
    Zend_Log::NOTICE => LOG_NOTICE, Zend_Log::INFO => LOG_INFO, 
    ...
    {
        $constants = array('LOG_AUTH', 'LOG_AUTHPRIV', 'LOG_CRON', 'LOG_DAEMON', 
