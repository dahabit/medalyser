...
abstract class Zend_Cache
{
     ...
     * @var array
     */
    public static $standardBackends = array('File', 'Sqlite', 'Memcached', 
    'Libmemcached', 'Apc', 'ZendPlatform', 'Xcache', 'TwoLevels', 'WinCache', 
    'ZendServer_Disk', 'ZendServer_ShMem');
    /**
    ...
    'Memcached', 'Libmemcached', 'Sqlite', 'WinCache');
    /**
    ...
    'Libmemcached', 'Apc', 'ZendPlatform', 'Xcache', 'WinCache', 'TwoLevels');
    /**
    ...
    $customFrontendNaming = false, $autoload = false)
    {
        ...
        if (in_array($frontend, self::$standardFrontends)) {
            ...
            if (! $customFrontendNaming) {
                // we use this boolean to avoid an API break
                $frontendClass = 'Zend_Cache_Frontend_' .
                 $frontend;
            } else {
