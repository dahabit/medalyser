...
class Zend_Markup_Parser_Textile implements Zend_Markup_Parser_ParserInterface
{
     ...
     * @var array
     */
    protected $_simpleTags = array('*' => 'strong', '**' => 'bold', 
    '_' => 'emphasized', '__' => 'italic', '??' => 'citation', '-' => 'deleted', 
    '+' => 'insert', '^' => 'superscript', '~' => 'subscript', '%' => 'span', 
    ...
    protected function _tokenize ()
    {
        ...
        $attrsMatch = implode('|', 
        array(self::MATCH_ATTR_CLASSID, self::MATCH_ATTR_STYLE, 
        self::MATCH_ATTR_LANG, self::MATCH_ATTR_ALIGN));
        $paragraph = '';
            ...
            switch ($state) {
                ...
                case self::STATE_NEW_PARAGRAPH:
                    ...
                    if ($matches['name'] == 'p') {
                        ...
                        $this->_tokens[] = array('tag' => $matches[0], 
                        'name' => $name, 
                        'type' => Zend_Markup_Token::TYPE_TAG, 
                ...
                case self::STATE_NEWLINE:
                    ...
                    $this->_tokens[] = array('tag' => $matches[0], 
                    'name' => $name, 'type' => Zend_Markup_Token::TYPE_TAG, 
                    'attributes' => $attributes);
                    break;
            }
        }
                ...
                if ($token['name'] == 'break') {
                    ...
                    if ($token['name'] == 'list') {
                        ...
                        if ($this->_current->getName() != 'list') {
                            ...
                            '', Zend_Markup_Token::TYPE_TAG, 'list', $attributes, 
                            $this->_current);
                    ...
                    // add the token
                    $child = new Zend_Markup_Token(
                    $token['tag'], Zend_Markup_Token::TYPE_TAG, $token['name'], 
