...
class Zend_Feed_Builder_Header extends ArrayObject
{
    ...
    public function setCloud ($uri, $procedure, $protocol)
    {
        ...
        array('uri' => $uri, 'procedure' => $procedure, 'protocol' => $protocol));
        return $this;
    }
    /**
    ...
    public function setTextInput ($title, $description, $name, $link)
    {
        ...
        array('title' => $title, 'description' => $description, 'name' => $name, 
        'link' => $link));
        return $this;
    }
    /**
    ...
    public function setSkipDays (array $days)
    {
        ...
        $valid = array('monday', 'tuesday', 'wednesday', 'thursday', 'friday', 
        'saturday', 'sunday');
        foreach ($days as $day) {
