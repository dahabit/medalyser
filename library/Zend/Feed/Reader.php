...
class Zend_Feed_Reader
{
    ...
    'feed' => array('DublinCore_Feed', 'Atom_Feed'), 
    'entry' => array('Content_Entry', 'DublinCore_Entry', 'Atom_Entry'), 
    'core' => array('DublinCore_Feed', 'Atom_Feed', 'Content_Entry', 
    'DublinCore_Entry', 'Atom_Entry'));
    /**
     * Get the Feed cache
     *
    ...
    public static function findFeedLinks ($uri)
    {
        ...
        if ($response->getStatus() !== 200) {
            ...
            require_once 'Zend/Feed/Exception.php';
            throw new Zend_Feed_Exception(
            "Failed to access $uri, got response code " . $response->getStatus());
        }
