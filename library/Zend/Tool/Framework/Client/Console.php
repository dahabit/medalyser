...
Zend_Tool_Framework_Client_Interactive_OutputInterface
{
    ...
    protected function _preInit ()
    {
        ...
        if (isset($config->basicloader) &&
         isset($config->basicloader->classes)) {
        ...
        array('classesToLoad' => $classesToLoad)));
        return;
    }
    /**
    ...
    Zend_Tool_Framework_Action_Interface $actionInterface, $missingParameterName)
    {
