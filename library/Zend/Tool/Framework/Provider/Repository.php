...
Zend_Tool_Framework_Registry_EnabledInterface, IteratorAggregate, Countable
{
    /**
    ...
    $overwriteExistingProvider = false)
    {
        ...
        if (! $overwriteExistingProvider && (array_key_exists(
        $providerName, $this->_unprocessedProviders) ||
