...
class Zend_Tool_Project_Context_Zf_ProjectProviderFile extends Zend_Tool_Project_Context_Filesystem_File
{
    ...
    {
        return array('projectProviderName' => $this->getProjectProviderName(), 
    ...
    public function getContents ()
    {
        ...
        array(
        'requiredFiles' => array('Zend/Tool/Project/Provider/Abstract.php', 
        'Zend/Tool/Project/Provider/Exception.php'), 'classes' => array($class)));
