...
class Zend_Tool_Project_Context_Zf_ControllerFile extends Zend_Tool_Project_Context_Filesystem_File
{
    ...
    {
        return array('controllerName' => $this->getControllerName());
    }
    /**
     * getName()
     *
    ...
    public function getContents ()
    {
        ...
        array('fileName' => $this->getPath(), 
        'classes' => array(
        new Zend_CodeGenerator_Php_Class(
        array('name' => $className, 'extendedClass' => 'Zend_Controller_Action', 
        'methods' => array(
...
EOS))))))));
        ...
        Zend_CodeGenerator_Php_File::registerFileCodeGenerator(
        $codeGenFile); // REQUIRES filename to be set
