...
Zend_Tool_Framework_Provider_Pretendable
{
    ...
    $controllerName, $moduleName = null)
    {
        ...
        $moduleName);
        return (($controllersDirectory->search(
        array('controllerFile' => array('controllerName' => $controllerName)))) instanceof Zend_Tool_Project_Profile_Resource);
    }
    /**
    ...
    public function create ($name, $indexActionIncluded = true, $module = null)
    {
        ...
        if ($request->isPretend()) {
            ...
            if (isset($indexActionResource)) {
                $response->appendContent(
                'Would create an index action method in controller ' . $name);
                $response->appendContent(
