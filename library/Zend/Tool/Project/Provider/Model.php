...
class Zend_Tool_Project_Provider_Model extends Zend_Tool_Project_Provider_Abstract
{
    ...
    $modelName, $moduleName = null)
    {
        ...
        array('modelFile' => array('modelName' => $modelName)))) instanceof Zend_Tool_Project_Profile_Resource);
    }
    /**
    ...
    public function create ($name, $module = null)
    {
        ...
        if ($request->isPretend()) {
            $response->appendContent(
            'Would create a model at ' . $modelResource->getContext()
                ->getPath());
            ...
            $response->appendContent(
            'Creating a model at ' . $modelResource->getContext()
                ->getPath());
