...
Zend_Tool_Framework_Provider_Pretendable
{
    ...
    $moduleName, Zend_Tool_Project_Profile_Resource $targetModuleResource = null)
    {
        ...
        if ($targetModuleResource == null) {
            ...
            $targetModuleEnabledResources = array('ControllersDirectory', 
            'ModelsDirectory', 'ViewsDirectory', 'ViewScriptsDirectory', 
            'ViewHelpersDirectory', 'ViewFiltersDirectory');
        }
        ...
        array('moduleDirectory' => array('moduleName' => $moduleName)))) {
            throw new Zend_Tool_Project_Provider_Exception(
            'A module named "' . $moduleName . '" already exists.');
        }
        // create the module directory
        $moduleDirectory = $modulesDirectory->createResource(
        ...
        array(
        'denyNames' => array('ModulesDirectory', 
        ...
        $moduleContextFilterIterator, RecursiveIteratorIterator::SELF_FIRST);
