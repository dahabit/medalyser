...
class Zend_Tool_Project_Provider_ProjectProvider extends Zend_Tool_Project_Provider_Abstract
{
    ...
    $projectProviderName, $actionNames = null)
    {
        ...
        'projectProviderFile', 
        array('projectProviderName' => $projectProviderName, 
    ...
    public function create ($name, $actions = null)
    {
        ...
        if ($this->_registry->getRequest()->isPretend()) {
            ...
            'Would create a project provider named ' . $name . ' in location ' .
             $projectProvider->getPath());
        } else {
            $this->_registry->getResponse()->appendContent(
            'Creating a project provider named ' . $name . ' in location ' .
             $projectProvider->getPath());
