...
Zend_Tool_Framework_Provider_Pretendable
{
    ...
    $actionName, $controllerName, $moduleName = null)
    {
        ...
        array('actionMethod' => array('actionName' => $actionName)))) instanceof Zend_Tool_Project_Profile_Resource);
    }
    /**
    ...
    Zend_Tool_Project_Profile $profile, $controllerName, $moduleName = null)
    {
    ...
    $module = null)
    {
        ...
        if ($name !== $originalName) {
            ...
            'Note: The canonical action name that ' . $tense .
             ' used with other providers is "' . $name . '";' . ' not "' .
             $originalName . '" as supplied', array('color' => array('yellow')));
        }
        ...
        if ($request->isPretend()) {
            $response->appendContent(
            'Would create an action named ' . $name . ' inside controller at ' .
            ...
            $response->appendContent(
            'Creating an action named ' . $name . ' inside controller at ' .
             $actionMethodResource->getParentResource()
                ->getContext()
                ->getPath());
        ...
        if ($viewIncluded) {
            ...
            if ($this->_registry->getRequest()->isPretend()) {
                ...
                'Would create a view script for the ' . $name .
                 ' action method at ' . $viewResource->getContext()
                    ->getPath());
            } else {
                $response->appendContent(
                'Creating a view script for the ' . $name . ' action method at ' .
