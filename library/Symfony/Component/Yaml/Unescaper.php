...
class Unescaper
{
    ...
    public function unescapeDoubleQuotedString ($value)
    {
        ...
        '/' . self::REGEX_ESCAPED_CHARACTER . '/u', $callback, $value);
    }
    /**
    ...
    public function unescapeCharacter ($value)
    {
        switch ($value{1}) {
            ...
            case 'N':
                // U+0085 NEXT LINE
                return $this->convertEncoding("\x00\x85", 
                self::ENCODING, 'UCS-2BE');
            case '_':
                // U+00A0 NO-BREAK SPACE
                return $this->convertEncoding("\x00\xA0", 
                self::ENCODING, 'UCS-2BE');
            case 'L':
                // U+2028 LINE SEPARATOR
                return $this->convertEncoding("\x20\x28", 
                self::ENCODING, 'UCS-2BE');
            case 'P':
                // U+2029 PARAGRAPH SEPARATOR
                return $this->convertEncoding("\x20\x29", 
                self::ENCODING, 'UCS-2BE');
            case 'x':
