...
abstract class Output implements OutputInterface
{
    ...
    'info' => array('fg' => 'green'), 'comment' => array('fg' => 'yellow'), 
    'question' => array('bg' => 'cyan', 'fg' => 'black'));
    protected static $options = array('bold' => 1, 'underscore' => 4, 
    'blink' => 5, 'reverse' => 7, 'conceal' => 8);
    protected static $foreground = array('black' => 30, 'red' => 31, 
    'green' => 32, 'yellow' => 33, 'blue' => 34, 'magenta' => 35, 'cyan' => 36, 
    'white' => 37);
    protected static $background = array('black' => 40, 'red' => 41, 
    'green' => 42, 'yellow' => 43, 'blue' => 44, 'magenta' => 45, 'cyan' => 46, 
    'white' => 47);
    /**
     * Constructor.
     *
    ...
    protected function replaceStartStyle ($match)
    {
        ...
        if (isset(static::$styles[strtolower($match[1])])) {
            ...
            strtolower($match[1]), $matches, PREG_SET_ORDER)) {
                throw new \InvalidArgumentException(
                sprintf('Unknown style "%s".', $match[1]));
            }
            $parameters = array();
